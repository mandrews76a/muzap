...
import { Music, Zap, Key, Mail, Lock, CheckCircle, AlertCircle } from 'lucide-react';
...
export default function ArtistLoginPage() {
  ...
  const [loginMethod, setLoginMethod] = useState('email'); // 'email' or 'nostr'
  ...
  const handleNostrLogin = async () => {
    ...
    try {
      ...
      const event = {
        ...
        tags: [],
        content: `Logging in to muzap.space at ${new Date().toISOString()}`
      };
    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-900 via-blue-900 to-black flex items-center justify-center p-4">
      <div className="max-w-md w-full">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-300">Log in to your artist account</p>
        </div>
          ...
          {loginMethod === 'email' ? (
            <div>
              ...
              <div className="mb-6">
                <div className="flex items-center justify-between mb-2">
                  ...
                  <a href="/artist/forgot-password" className="text-xs text-purple-400 hover:text-purple-300">
                    Forgot password?
                  </a>
                </div>
                <div className="relative">
            ...
            <div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-purple-300 text-xs">
                      Use your Nostr identity to log in. Make sure you have a Nostr browser extension installed (nos2x, Alby, etc.)
                    </p>
                  </div>
                </div>
              </div>
              ...
              <button
                ...
                className="w-full bg-gradient-to-r from-purple-600 to-blue-600 text-white font-bold py-3 px-6 rounded-lg hover:from-purple-700 hover:to-blue-700 transition-all disabled:opacity-50 disabled:cursor-not-allowed"
              >
                {loading ? 'Connecting...' : 'Log In with Nostr'}
              </button>
            </div>
          )}
        </div>
        ...
        <div className="text-center mt-6">
          <p className="text-gray-400 text-sm">
            ...
            <a href="/artist/signup" className="text-purple-400 hover:text-purple-300 font-medium">
              Sign up
            </a>
          </p>
        </div>
        ...
        <div className="mt-12 grid grid-cols-3 gap-4">
          <div className="text-center">
            ...
            <p className="text-xs text-gray-400">Lightning Payments</p>
          </div>
          <div className="text-center">
            <div className="bg-white/5 rounded-lg p-4 mb-2">
              <Music className="w-6 h-6 text-purple-400 mx-auto" />
            </div>
            <p className="text-xs text-gray-400">Upload Albums</p>
          </div>
          <div className="text-center">
            <div className="bg-white/5 rounded-lg p-4 mb-2">
              <Key className="w-6 h-6 text-blue-400 mx-auto" />
            </div>
            <p className="text-xs text-gray-400">Nostr Identity</p>
          </div>
        </div>
      </div>
    </div>
